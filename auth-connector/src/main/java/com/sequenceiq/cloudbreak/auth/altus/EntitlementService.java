...
import static com.sequenceiq.cloudbreak.auth.altus.model.Entitlement.AWS_GP3_DISK_SUPPORT;
...
public class EntitlementService {
    ...
    public boolean isAwsGp3SupportEnabled(String accountId) {
        return isEntitlementRegistered(accountId, AWS_GP3_DISK_SUPPORT);
    }
